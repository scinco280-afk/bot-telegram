...
GRUPO_25 = "https://t.me/melvalierr"
GRUPO_60 = "https://t.me/melvaliervip"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("💋 Ver agora (R$25)", callback_data="plano_25")],
        [InlineKeyboardButton("🔥 Quero tudo (R$60)", callback_data="plano_60")],
    ]
